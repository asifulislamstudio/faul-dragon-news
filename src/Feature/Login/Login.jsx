          ...
          <div className="p-44">
            <div className="flex h-full items-center justify-center md:p-0">
                <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md">
                    {/* design side  */}
                    <div className="relative hidden items-center justify-center bg-rose-700 md:flex md:w-[50%]">
                        <div className="absolute -top-2 left-[20%] h-16 w-16 rounded-full bg-gradient-to-br from-white via-rose-400 to-rose-700"></div>
                        <div className="absolute bottom-[18%] left-[20%] h-20 w-20 rounded-full bg-gradient-to-br from-white via-rose-400 to-rose-700"></div>
                    ...
                    <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                        ...
                        <form onSubmit={handleLogin} className="flex w-full flex-col items-center justify-center gap-4">
                            ...
                            <input
                                className="w-[80%] relative rounded-lg border border-rose-700 bg-transparent py-2 pl-4 text-zinc-600 focus:outline-none focus:ring-2 focus:ring-rose-400/50 md:w-[60%] dark:text-zinc-400"
                        ...
                        <div className="my-8 flex items-center px-8">
                            <hr className="flex-1 border-rose-700" />
                            <div className="mx-4 text-rose-700">OR</div>
                            <hr className="flex-1 border-rose-700" />
                        </div>
                       
                        <div className="flex lg:flex-row md: flex-col ">
                             {/* sign with google */}
                        <button  className="group mb-4 mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-rose-700">
                            <div className="relative z-20 flex h-full items-center bg-rose-700 px-4 text-lg text-white duration-300 group-hover:bg-transparent group-hover:text-rose-700">
                                Signin with
                            </div>
                            <span className="flex h-full items-center px-4 text-xl font-bold text-rose-700 duration-300 group-hover:bg-rose-700 group-hover:text-white">
                            ...
                            {/* sign with github */}
                            <button className="group mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-rose-700">
                            <div className="relative z-20 flex h-full items-center bg-rose-700 px-4 text-lg text-white duration-300 group-hover:bg-transparent group-hover:text-rose-700">
                                Signin with
                            </div>
                            <span className="flex h-full items-center px-4 text-xl font-bold text-rose-700 duration-300 group-hover:bg-rose-700 group-hover:text-white">
